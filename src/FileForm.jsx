...
export default function FileForm({ onRead }) {
    ...
    return (
        <div onDragLeave={onDragLeave} onDragOver={onDragOver} onDragEnter={onDragEnter} onDrop={onDrop} style={{ borderStyle: "dotted", borderWidth: "5px 5px 5px 5px", borderColor: (visualState === 'default' ? "black" : "green"), width: "100%", height: "100%" }}>
            {
                (visualState === 'default') ?
